    ...
    fn start(
        ...
        let handle = thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let (tx_state_dev, rx_state_dev) = mpsc::sync_channel(0);
                ...
                barrier.wait();
                debug!("Playback device starting now!");
                loop {
            ...
            .spawn(move || {
                ...
                let _handle = thread::Builder::new()
                    ...
                    .spawn(move || {
                        ...
                        match open_capture(&devname, samplerate, channels, &sample_format_dev, exclusive, loopback) {
                ...
                barrier.wait();
                debug!("Capture device starting now!");
                loop {
